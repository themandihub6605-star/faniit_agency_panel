    ...
    <div className="pt-8 pb-10">
      <Container>
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Link to="/edit" className="rounded-full border border-white/15 px-4 py-2 text-sm font-semibold text-white/80 hover:border-orange-400 hover:text-orange-300">
            Edit Profile
          </Link>
        </div>
